...
<section class="container" style="padding-bottom: 24px">
    <div class="row align-items-center">
        <div class="col-8 text-white">
            ...
            <h4 class="mt-4">Nhóm 11</h4>
            <ul class="mt-2">
                <li>Lê Thanh Giác - CT06N0118</li>
                <li>Võ Trường Lâm - CT06N0129</li>
                <li>Nguyễn Thanh Bảo - CT06N0104</li>
                <li>Phạm Phú An - CT06N0102</li>
                <li>Bùi Trọng Nghĩa - CT06N0139</li>
            </ul>
        </div>
        <div class="col-4">
